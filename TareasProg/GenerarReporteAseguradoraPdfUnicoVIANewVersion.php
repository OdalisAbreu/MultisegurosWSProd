...
while ($RowHist = mysql_fetch_array($QueryH)) {
	...
	if ($RowHist['tipo'] == 'serv') {
		...
		$html_servicios_opcionales .= '<tr>
			<td align="left" width="265" colspan="2">' . ServAdicHistory($RowHist['id_serv_adc']) . " - Incluido" . '</td>
		</tr>';
		$html .= '<tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <tr style="margin-top:12px">
		<td align="left" ><img src="' . $logo . $NombreImg . '"  alt="" width="95px"/></td>
