  ...
  <table cellpadding="4" cellspacing="0">
	...
	<tr>
	  ...
	  <td align="center" colspan="3"> 
	  	<b style="font-size: 19px;">Fecha del Reporte</b><br>
		<font style="font-size: 14px; color: #828282; font-weight: bold;">
   ...
   <tr style="background-color:#B1070A; color:#FFFFFF; font-size:14px;">
		...
		<td>Agencia</td>
        <td width="250px">Inicio Vigencia</td>
        <td width="250px">Fin Vigencia</td>
        <td>Prima</td>
   </tr> ';
	...
	$direccion = str_replace(",", "", $cliente[1]);
	
$html .='
	<tr>
   		<td>'.$t.'</td>
        <td  style="width:250px">'.$prefi.'</td>
        <td>'.$cliente[0].'</td>
        <td>'.$cliente[1].'</td>
        <td  style="width:250px">'.CedulaPDF($cliente[2]).'</td>
		<td  style="width:350px">'.$direccion.'</td>
        <td style="width:250px">'.Ciudad($cliente[4]).'</td>
        <td style="width:250px">'.Telefono($cliente[5]).'</td>
        <td style="width:250px">'.$marca.'</td>
        <td style="width:250px">'.$modelo.'</td>
        <td>'.$veh[3].'</td>
        <td>'.$veh[5].'</td>
        <td>'.$veh[4].'</td>
        <td style="width:250px">'.FechaHoraNew($u['fecha']).'</td>
		<td>'.$u['id'].'</td>
        <td style="width:250px">'.Fecha($u['fecha_inicio']).'</td>
        <td style="width:250px">'.Fecha($u['fecha_fin']).'</td>
...
$html .='
	...
	$sfile	= "EXCEL/DOM/MS_RDV_$fDesde.xls"; // Ruta del archivo a generar 
